            ...
            <section class="cta section" id="contact">
                <div class="container cta__container">
                    <div class="cta__content">
                        <h2 class="cta__title">Siap Tingkatkan Bisnis Anda?</h2>
                        <p class="cta__description">
                            Diskusi kebutuhan website Anda secara gratis. 
                        ...
                        <p class="cta__note">Biasanya merespons dalam 1-2 jam</p>
                    </div>
                </div>
            </section>
                    ...
                    <div class="footer__content">
                        <div class="footer__brand">
                            ...
                            <p class="footer__description">
                                Solusi web profesional untuk personal brand dan UMKM Indonesia.
                            </p>
                        </div>
