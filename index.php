    ...
    <section class="hero" id="hero">
        <div class="container hero__container">
            <div class="hero__content">
                <span class="hero__badge">Jasa Web Development Terpercaya</span>
            ...
            <div class="hero__problem">
                <h3 class="hero__problem-title">Apakah Anda menghadapi masalah ini?</h3>
                <div class="hero__problem-list">
                    <div class="hero__problem-item">
            ...
            <div class="services__grid">
                ...
                <div class="service-card">
                    ...
                    <p class="service-card__description">
                        Landing page, company profile, dan website bisnis yang responsif, SEO-friendly, dan mudah dikelola.
                    </p>
                ...
                <!-- Service 2: Chatbot -->
                <div class="service-card">
                    <div class="service-card__icon" style="background-color: var(--color-accent);">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                        </svg>
                    </div>
                    <h3 class="service-card__title">Chatbot Development</h3>
                    <p class="service-card__description">
                ...
                <div class="service-card">
                    <div class="service-card__icon" style="background-color: var(--color-primary-dark);">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="service-card__description">
                        Aplikasi kustom untuk automasi bisnis, dashboard, dan sistem manajemen data.
                    </p>
                    <div class="service-card__features">
                        <div class="service-card__feature">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <section class="trust section" id="trust">
        <div class="container trust__container">
            <div class="trust__content">
                ...
                <p class="trust__bio">
                    Saya adalah web developer berpengalaman yang fokus membantu Personal Brand dan UMKM 
 membangun kehadiran digital yang profesional. Dengan lebih dari <strong>5 tahun pengalaman</strong>, 
 saya telah membantu puluhan klien meningkatkan bisnis mereka melalui website yang berkualitas.
                    <br><br>
                    Fokus saya adalah memberikan solusi yang tepat sasaran, tanpa complicate, 
 dengan hasil yang memuaskan. Setiap proyek saya tangani dengan penuh dedikasi dan komitmen.
                </p>
                
                <div class="trust__stats">
                    <div class="stat">
                        <div class="stat__number">50+</div>
                        <div class="stat__label">Proyek Selesai</div>
                    </div>
                    <div class="stat">
                        <div class="stat__number">5+</div>
                        <div class="stat__label">Tahun Pengalaman</div>
                    </div>
                    <div class="stat">
                        <div class="stat__number">98%</div>
                        <div class="stat__label">Kepuasan Klien</div>
                    </div>
                </div>
            ...
            <div class="portfolio__grid">
                ...
                <article class="portfolio-card">
                    ...
                    <div class="portfolio-card__content">
                        <span class="portfolio-card__category">Landing Page</span>
                        <h3 class="portfolio-card__title">Fashion Brand Landing Page</h3>
                        <p class="portfolio-card__description">
                            Landing page responsif untuk brand fashion lokal dengan sistem produk showcase dan lead generation.
                        </p>
                ...
                <article class="portfolio-card">
                    <img src="src/assets/images/placeholder.svg" 
                         ...
                         loading="lazy">
                    <div class="portfolio-card__content">
                        <span class="portfolio-card__category">Company Profile</span>
                        <h3 class="portfolio-card__title">Konsultan Bisnis Website</h3>
                        <p class="portfolio-card__description">
                            Company profile profesional untuk konsultan bisnis dengan sistem appointment booking.
                        </p>
                        <a href="#" class="portfolio-card__link">
                            Lihat Detail
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <article class="portfolio-card">
                    <img src="src/assets/images/placeholder.svg" 
                         ...
                         loading="lazy">
                    <div class="portfolio-card__content">
                        <span class="portfolio-card__category">E-commerce</span>
                        <h3 class="portfolio-card__title">UMKM Online Store</h3>
                        <p class="portfolio-card__description">
                            Toko online lengkap dengan sistem pembayaran, inventory, dan admin dashboard untuk UMKM.
                        </p>
                        <a href="#" class="portfolio-card__link">
                            Lihat Detail
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <section class="pricing section" id="pricing">
        <div class="container">
            <h2 class="section__title">Paket Harga</h2>
            <p class="section__subtitle">
                Transparan dan sesuai kebutuhan Anda
            </p>
            ...
            <div class="pricing__grid">
                ...
                <div class="pricing-card">
                    ...
                    <p class="pricing-card__description">
                        Landing page sederhana untuk personal brand atau bisnis kecil
                    </p>
                    <div class="pricing-card__price">
                        <span class="pricing-card__amount">Rp 500rb</span>
                        <span class="pricing-card__period">/ proyek</span>
                    </div>
                ...
                <div class="pricing-card pricing-card--featured">
                    <span class="pricing-card__badge">TERPOPULER</span>
                    <h3 class="pricing-card__name">Standard</h3>
                    <p class="pricing-card__description">
                        Company profile lengkap untuk UMKM yang serius bisnis
                    </p>
                    <div class="pricing-card__price">
                        <span class="pricing-card__amount">Rp 1,5jt</span>
                        <span class="pricing-card__period">/ proyek</span>
                    </div>
                    <ul class="pricing-card__features">
                        <li class="pricing-card__feature">
                ...
                <!-- Premium Package -->
                <div class="pricing-card">
                    <span class="pricing-card__badge">PREMIUM</span>
                    <h3 class="pricing-card__name">Premium</h3>
                    <p class="pricing-card__description">
                        Website lengkap dengan fitur advanced dan integrasi
                    </p>
                    <div class="pricing-card__price">
                        <span class="pricing-card__amount">Rp 3jt+</span>
                        <span class="pricing-card__period">/ proyek</span>
                    </div>
                    <ul class="pricing-card__features">
                        <li class="pricing-card__feature">
            ...
            <p class="text-center mt-1" style="color: var(--color-text-secondary); font-size: var(--font-size-sm);">
                * Harga dapat berubah sewaktu-waktu. Konsultasi untuk mendapat harga terbaik.
            </p>
        </div>
    </section>
